...
public static class AuthConfiguration
{
    ...
    private static void ConfigureAuthorizationPolicies(IServiceCollection services)
    {
        ...
        {
            options.AddPolicy("administratorcPolicy", policy => policy.RequireRole("administratorc"));
            options.AddPolicy("administratorsPolicy", policy => policy.RequireRole("administrators"));
            options.AddPolicy("staffPolicy", policy => policy.RequireRole("staff"));
            options.AddPolicy("allRolesPolicy", policy => policy.RequireRole("staff", "administratorc", "administrators"));
